...
public class tester : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        float Angle_reward = CalculatePenalty2(Gripper_angle, angleDiff, deviation);
        Debug.Log("Gripper Angle: " + angleDiff);
        Debug.Log("Target Angle: " + Gripper_angle);
    ...
    float CalculatePenalty2(float Gripper_angle, float rotation_angle, float deviation)
    {
