...
public class PlatformAgent : Agent
{
    ...
    {
        float rotation_angle_abs = Math.Abs(rotation_angle);
        ...
        float penalty2 = (float)Math.Exp(Math.Pow(rotation_angle_abs, 2) / (2 * Math.Pow(deviation, 2)));
