...
public class tester : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float speedLimitFactor = (float)Math.Tanh(Vector3.Distance(midpoint, target.transform.position)*2.0f); // Use a tanh function for smooth limitation
        float desiredSpeed = speedLimitFactor * 0.5f;
